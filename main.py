		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					links['Thesis'] = {'List':'/thesis/list/all','Create Entry':'/thesis/create'}
					template_values = {
						'links':links,
						'search_url':'/search',
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_index.html')
					...
					links['Thesis'] = {'List':'/thesis/list/all'}
					template_values = {
						'links':links,
						'search_url':'/search',
						'logout_url': users.create_logout_url('/'),
			...
			template = JINJA_ENVIRONMENT.get_template('/pages/__login.html')
			self.response.write(template.render(template_values))
...
class APIHandler(webapp2.RequestHandler):
	def get(self):
		...
		if loggedin_user:
			...
			template = JINJA_ENVIRONMENT.get_template('/pages/_login.html')
			self.response.write(template.render(template_values))		
		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_faculty.html')
					self.response.write(template.render(template_values))
				else:
					self.redirect('/home')
			else:
		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_student.html')
					self.response.write(template.render(template_values))
				else:
					self.redirect('/home')
			else:
		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_university.html')
					self.response.write(template.render(template_values))
				else:
					self.redirect('/home')
			else:
		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_college.html')
					self.response.write(template.render(template_values))
				else:
					self.redirect('/')
			else:
		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_department.html')
					self.response.write(template.render(template_values))
				else:
					self.redirect('/')
			else:
		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_college_list.html')
					self.response.write(template.render(template_values))
				else:
					link_text = 'Logout'
					links = {}
			...
			template = JINJA_ENVIRONMENT.get_template('/pages/___login.html')
			self.response.write(template.render(template_values))
		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_department_list.html')
					self.response.write(template.render(template_values))
				else:
					link_text = 'Logout'
					links = {}
		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_college_edit.html')
					self.response.write(template.render(data))
				else:
					self.redirect('/')
		...
		if loggedin_user:
			...
			if user:
				if user.is_admin:
					...
					template = JINJA_ENVIRONMENT.get_template('/pages/_department_edit.html')
					self.response.write(template.render(data))
				else:
					self.redirect('/')
